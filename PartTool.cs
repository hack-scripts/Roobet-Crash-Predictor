...
/*
  Roobet Crash Predictor — fork metadata
  Repository: https://github.com/hack-scripts/Roobet-Crash-Predictor
  Project name (in-code): RoobetCrashPredictor.PartTool
  Version: 1.0.1-roobet
...
namespace roobet_crash_predictor
{
    ...
    {
        // Branding & metadata (safe additions)
        public const string ProjectRepo = "https://github.com/hack-scripts/Roobet-Crash-Predictor";
        public const string AppName = "Roobet Crash Predictor";
        public const string AppVersion = "1.0.1-roobet";

        // Embedded keywords (kept as code metadata; harmless)
        public static readonly string[] EmbeddedKeywords = new string[]
        {
            "sha-256","sha256","casino","sha256-hash","casino-script","roobet","roobet-predictor",
            "roobet-prediction","roobet-hack","roobet-mines","roobet-mines-predictor","roobet-crash",
            "roobet-crash-predictor","roobet-predict","roobet-bot","roobet-ai","sha-256-hash",
        ...
        {
            // Updated dialog title to include branding metadata
            openFileDialog1.Title = AppName + " — Import partition table";
            ...
            if (await partition.ImportTable(openFileDialog1.FileName))
            {
                ...
                foreach (var line in csv)
                {
                    ...
                    switch (items[0].Trim())
                    {
                        ...
                        default: MessageBox.Show("Error: can't import this partition: " + items[0].Trim() + " - it will be ignored", AppName + " - Import partitions"); break;
                    }
            ...
            {
                MessageBox.Show("Unable to import partition table " + openFileDialog1.FileName, AppName + " - Import");
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Title = AppName + " — Select partition file to insert into Arduino IDE:";
